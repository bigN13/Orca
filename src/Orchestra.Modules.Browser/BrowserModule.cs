...
namespace Orca.Modules.Browser
{
    using System;
    ...
    public class BrowserModule : ModuleBase
    {
        ...
        {
            Application.Current.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("/Orca.Modules.Browser;component/ResourceDictionary.xaml", UriKind.RelativeOrAbsolute) });
        }
    }
}